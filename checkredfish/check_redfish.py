...
from checkredfish.cr_module.system_chassi import get_system_info, get_chassi_data, get_system_data
from checkredfish.cr_module.nic import get_network_interfaces
from checkredfish.cr_module.storage import get_storage
from checkredfish.cr_module.bmc import get_bmc_info
from checkredfish.cr_module.firmware import get_firmware_info
from checkredfish.cr_module.event import get_event_log
from checkredfish.cr_module.classes.redfish import default_conn_max_retries, default_conn_timeout
from checkredfish.cr_module.classes.inventory import Fan, PowerSupply, Temperature, Memory, Processor


def parse_command_line(caller: str):
...
if __name__ == "checkredfish.check_redfish":
    ...
    if os.path.basename(sys.argv[0]) != "__main__.py":
        args = parse_command_line(sys.argv[0])
    else:
        args = parse_command_line("python -m checkredfish")
